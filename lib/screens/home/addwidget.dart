                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InputField(
                          ...
                          lines: 5,
                          onChanged: (val) {
                            setState(() => _infolink = val);
                          },
                          validator: (val) =>
                              val.isEmpty ? 'Pleases enter a link' : null,
                        ),
                        // Category
                        Padding(
                          padding:
                              EdgeInsets.only(top: 30, left: 10, bottom: 15),
                          child: Text(
                            'Category',
                            style: TextStyle(
                                fontSize: 18,
                        ...
                        InputField(
                          title: 'Construtor',
                          labeltext: 'Enter constructor',
                          lines: 5,
                          onChanged: (val) {
                            setState(() => _constructor = val);
                          },
                          validator: (val) =>
                              val.isEmpty ? 'Pleases enter construtor' : null,
                        ),
                        InputField(
                          title: 'Description',
                          labeltext: 'Description for this widget',
                          lines: 4,
                          onChanged: (val) {
                            setState(() => _description = val);
                          },
                          validator: (val) =>
                              val.isEmpty ? 'Pleases enter description' : null,
                        ),
                        InputField(
                            title: 'Other',
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (_formKey.currentState.validate()) {
                                dynamic result = WidgetsController().addWidget(
                                    title: _title,
                                    infolink: _infolink,
...
class CategroyWidget extends StatelessWidget {
  const CategroyWidget({
    Key key,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // final list = ['All', 'Home', 'Decoration'];
