              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InputField(icon: Icon(Icons.person,color: Color.fromRGBO(175, 189, 209, 1)),labeltext: 'Enter Email',lines: 1,onChanged: (val){setState(() => _email = val);}, validator: (val) => val.isEmpty ?'Invalid title':null,),
                  ),  
                  Padding(
                    padding: const EdgeInsets.all(10.0),
                    child: InputField(icon: Icon(Icons.lock,color: Color.fromRGBO(175, 189, 209, 1)),labeltext: 'Enter Password',lines: 1,onChanged: (val){setState(() => _password = val);}, validator: (val) => val.isEmpty ?'Invalid password. Please input more then 6 char':null,),
                  ),  
                  ElevatedButton(
                onPressed: () async {
